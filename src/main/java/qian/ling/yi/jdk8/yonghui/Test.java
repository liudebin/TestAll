package qian.ling.yi.jdk8.yonghui;
...
//
        ...
        Function<String, Employee> times2 = fun -> {
            return getEmployee();
        };
//
        ...
        Map<String,Employee> eventmap1= Stream.of(testintStrings)
                .collect(Collectors
        ...
        //再简洁点
        eventmap1 = Stream.of("1","2","3","4")
                .collect(Collectors.toMap(inputvalue -> inputvalue, inputvalue -> getEmployee())); // inputvalue 没起作用




        eventmap1.forEach((k,v)->{
