...
public class HttpClientUtil {
    ...
    private static void doSSLPost(String url, Map<String, String> map, String charset) {
        ...
        try {
            ...
            SSLSocketFactory socketFactory = new SSLSocketFactory(null, null, trustStore);
//            SSLSocketFactory socketFactory = new SSLSocketFactory(keyStore, KEY_STORE_PASSWORD, null);
