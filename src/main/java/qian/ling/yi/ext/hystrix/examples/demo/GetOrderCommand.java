 ...
 */
package qian.ling.yi.ext.hystrix.examples.demo;

import com.netflix.hystrix.HystrixCommand;
import com.netflix.hystrix.HystrixCommandGroupKey;

/**
 * Sample HystrixCommand simulating one that would fetch Order objects from a remote services or database.
 * <p>
...
public class GetOrderCommand extends HystrixCommand<Order> {
    ...
    protected Order run() {
        ...
        /* success ... create Order with data "from" the remote services response */
