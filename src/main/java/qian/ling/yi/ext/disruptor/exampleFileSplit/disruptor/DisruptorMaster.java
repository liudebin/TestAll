...
import qian.ling.yi.ext.disruptor.exampleFileSplit.Constants;
import qian.ling.yi.ext.disruptor.exampleFileSplit.Master;
import qian.ling.yi.ext.disruptor.exampleFileSplit.Util;
...
//			BlockingQueue<FileLine> queue = new SynchronousQueue<FileLine>();
	...
	public static void main(String[] args) {
		...
		Master master = new DisruptorMaster("D:\\temp",  "test.csv", 10,1,  24,  8,  2048);
		master.init();
		master.excute();
	}
